...
if __name__ == "__main__":
    ...
    sol_t0 = [
        [-5.556187890954266, -19.903305474229317, -7.466117953001646, 31.72649951339433, -19.514258213422313],
        ...
        [-0.7664503306318622, -29.413157279363915, -30.40131419830396, 25.947020368046573, -23.219785119887813],
        [-23.92245707040432, -21.73899420904505, -27.69607776499083, -18.40294402742068, 16.62977494412241],
    ]

    vel_t0 = [
        [2.92, 8.58, 9.9, 9.33, 6.3],
        [4.37, 7.5, 0.31, 6.52, 0.48],
        [9.37, 5.98, 6.93, 5.99, 5.35],
        [5.39, 0.56, 1.73, 3.8, 9.13],
        [3.47, 7.37, 0.42, 1.01, 6.56],
        [6.68, 7.61, 9.18, 5.24, 2.98],
        [5.63, 0.1, 1.22, 0.97, 6.54],
        [4.91, 5.49, 5.95, 0.7, 8.55],
        [0.29, 6.96, 8.81, 6.76, 5.35],
